...
export const HomeCitizenScreen = () => {
  ...
  const { init, changeTravel, dataTravelContext, removeTravel } =
  ...
  const [openModalArrivedDriverMsg, setOpenModalArrivedDriverMsg] =
    useState(false);
  ...
  // console.debug("👁️ dataTravelContext", dataTravelContext);
  return (
    <Fragment>
      <View
        style={{
